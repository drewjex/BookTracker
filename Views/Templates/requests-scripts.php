...
<script>
    ...
    var table = $('#datatable-responsive').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "?controller=command&action=ajax_book_requests" 
    });

    //on search_by.change, make ajax call or something that updates session variable with id of option. Then just use that value when searching.
